...
define('COMPONENT_PATH', MODX_CORE_PATH.'/components/ditsformsaver/');
...
// - the schema xml file
$builder->buildSchema(COMPONENT_PATH.'/model/', COMPONENT_PATH.'/model/schema/ditsformsaver.mysql.schema.xml');
